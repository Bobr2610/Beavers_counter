/**
 * Cloudflare Worker: view counter with beaver images.
 * Increments on each request and returns SVG with embedded beaver digits.
 *
...
export default {
  async fetch(request, env) {
    ...
    // Fetch digit images and embed as data URLs (GitHub blocks external refs in SVG)
